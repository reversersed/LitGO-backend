...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/books/genre/{name}": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "ID or translit name",
                        "name": "name",
                        "in": "path",
                        "required": true
                    },
                    ...
                    {
                        "type": "boolean",
                        "description": "Searches only high (4+) rating",
                        "name": "onlyhighrating",
                        "in": "query"
                    },
                    {
                        "type": "integer",
                        "description": "Books limit to find",
                        "name": "limit",
                        "in": "query",
                        "required": true
                    },
        ...
        "/books/list": {
            "get": {
                "description": "there can be multiple search parameters, id or translit, or both\nexample: ?id=1\u0026id=2\u0026translit=book-21\u0026id=3\u0026translit=book-756342",
                "produces": [
                    "application/json"
                ],
                "tags": [
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Book Id, must be a primitive id hex",
                        "name": "id",
                        "in": "query"
                    },
                    {
                        "type": "string",
                        "description": "Translit book name",
                        "name": "translit",
                        "in": "query"
                    }
                ],
