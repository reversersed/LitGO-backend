...
import (
	...
	"github.com/reversersed/LitGO-backend/tree/main/api_review/pkg/rabbitmq"
)
...
type ServerConfig struct {
	...
	UserServiceURL string `env:"SERVICE_USER_URL" env-required:"true" env-description:"External host to user service"`
}
