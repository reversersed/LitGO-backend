...
type GetSuggestionRequest struct {
	...
	// max objects to find
	Limit int32 `protobuf:"varint,2,opt,name=limit,proto3" json:"limit,omitempty" form:"limit" validate:"required,gte=1,lte=10"`  
}
...
func (x *GetSuggestionRequest) GetLimit() int32 {
	if x != nil {
		return x.Limit
	}
	return 0
...
var file_author_service_proto_rawDesc = []byte{
	...
	0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x42, 0x1e, 0x5a, 0x1c, 0x70, 0x6b, 0x67, 0x2f, 0x70, 0x72,
	0x6f, 0x74, 0x6f, 0x2f, 0x61, 0x75, 0x74, 0x68, 0x6f, 0x72, 0x73, 0x3b, 0x61, 0x75, 0x74, 0x68,
